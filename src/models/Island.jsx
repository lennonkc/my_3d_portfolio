...
export function Island({
  ...
  useFrame(() => {
    ...
    if (!isRotating) {
      ...
      switch (true) {
        case normalizedRotation >= 0.52 && normalizedRotation <= 2.61:
          setCurrentStage(1);
          break;
        case normalizedRotation >= 3.14 && normalizedRotation <= 5.23:
          setCurrentStage(2);
          break;
        case normalizedRotation >= 5.76 && normalizedRotation <= 6.20:
          setCurrentStage(3);
          break;
        default:
